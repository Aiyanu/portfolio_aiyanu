...
export default function EducationSection() {
    return (
        <section id="education" className="py-12 space-y-4">
            <div>
                <h2 className="text-2xl sm:text-3xl font-semibold text-white mb-6">Education</h2>
                <Underline className="w-16 -mt-4" />
            </div>

            <div className="border border-gray-700 rounded-2xl p-6 shadow-sm">
                <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4">
                    <div>
                        <h3 className="text-lg sm:text-xl font-bold text-white">
                            Bachelor of Science (B.Sc.) in Computer Science
                        </h3>
                        <p className="text-sm text-gray-300">First Class Division — GPA: <span className="font-medium">4.63 / 5.00</span></p>
                    ...
                    <div className="text-sm text-gray-400 md:text-right">
                        ...
                        <span className="block font-medium mt-1">October 2024</span>
                    </div>
                </div>
